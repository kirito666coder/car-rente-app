...
export default function Hero() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 ml-10 md:ml-20 mt-20 ">
            <div className="md:mt-50 md:ml-20">
                <h1 className="font-semibold text-5xl md:text-7xl">Premium Car rental in your Area</h1>
                <p className="mt-8 text-gray-500 font-semibold text-2xl max-w-[90%]">Book the selected car effortiessly, Pay for driving only, Book the Cra Now</p>
